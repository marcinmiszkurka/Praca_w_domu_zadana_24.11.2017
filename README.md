# Praca_w_domu_zadana_24.11.2017
 ...
 <h1>     I - POZYCYJNE SYSTEMY LICZBOWE<h1> (2,8,10,16) <br><br><br>
...
TEMAT 1 - SYSTEM DWÓJKOWY binarny (BIN)) (2) <br><hr>
  ...
  <br><br><br>
  TEMAT 2 - SYSTEM ÓSEMKOWY(oktalny(OKT)) (8)<br><hr>
 Ósemkowy system liczbowy - mamy osiem cyfr: 0, 1, 2,…,7 gdzie 0 liczone jest jako cyfra pierwsza. Podstawą systemu jest liczba 8. <br>
  ...
  <br><br><br>
  TEMAT 3 - SYSTEM DZIESIĘTNY (10) <br><hr>
...
<br><br><br>
  TEMAT 4 - system szesnastkowy (heksegalny (HEX)) (16)<br><hr>
